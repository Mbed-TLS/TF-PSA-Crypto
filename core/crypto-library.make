...
TF_PSA_CRYPTO_LIBRARY_GENERATED_FILES := \
	$(TF_PSA_CRYPTO_DISPATCH_PATH)/psa_crypto_driver_wrappers.h \
	$(TF_PSA_CRYPTO_DISPATCH_PATH)/psa_crypto_driver_wrappers_no_static.c \
...
$(GENERATED_WRAPPER_FILES):
	...
	$(PYTHON) ../tf-psa-crypto/scripts/generate_driver_wrappers.py $(TF_PSA_CRYPTO_DISPATCH_PATH)

$(TF_PSA_CRYPTO_CORE_PATH)/psa_crypto.o:$(TF_PSA_CRYPTO_DISPATCH_PATH)/psa_crypto_driver_wrappers.h
...
TF_PSA_CRYPTO_LIBRARY_GENERATED_OBJS = $(TF_PSA_CRYPTO_DISPATCH_PATH)/psa_crypto_driver_wrappers_no_static.o
