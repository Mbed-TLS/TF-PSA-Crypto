...
#if defined(MBEDTLS_PSA_ACCEL_KEY_TYPE_ML_DSA_PUBLIC_KEY)
#undef MBEDTLS_PSA_ACCEL_KEY_TYPE_ML_DSA_PUBLIC_KEY
#else
#define MBEDTLS_PSA_ACCEL_KEY_TYPE_ML_DSA_PUBLIC_KEY 1
#endif
#endif
