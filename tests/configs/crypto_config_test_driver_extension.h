...
#undef MBEDTLS_PSA_ACCEL_ALG_BLAKE2S_HASH256
#else
#define MBEDTLS_PSA_ACCEL_ALG_BLAKE2S_HASH256 1
#endif
#endif

#if defined(PSA_WANT_ALG_BLAKE2B_HASH512)
#if defined(MBEDTLS_PSA_ACCEL_ALG_BLAKE2B_HASH512)
#undef MBEDTLS_PSA_ACCEL_ALG_BLAKE2B_HASH512
#else
#define MBEDTLS_PSA_ACCEL_ALG_BLAKE2B_HASH512 1
#endif
#endif
