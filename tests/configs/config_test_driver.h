...
#ifndef PSA_CRYPTO_TESTS_CONFIGS_CONFIG_TEST_DRIVER_H
#define PSA_CRYPTO_TESTS_CONFIGS_CONFIG_TEST_DRIVER_H

#if defined(_MSC_VER) && !defined(_CRT_SECURE_NO_DEPRECATE)
#define _CRT_SECURE_NO_DEPRECATE 1
#endif

#endif /* PSA_CRYPTO_TESTS_CONFIGS_CONFIG_TEST_DRIVER_H */
