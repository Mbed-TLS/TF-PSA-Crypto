...
#define MBEDTLS_MD_SOME_PSA
#endif
#if defined(MBEDTLS_PSA_ACCEL_ALG_BLAKE2S_HASH256)
#define MBEDTLS_MD_BLAKE2S_VIA_PSA
#define MBEDTLS_MD_SOME_PSA
#endif
#if defined(MBEDTLS_PSA_ACCEL_ALG_BLAKE2B_HASH512)
#define MBEDTLS_MD_BLAKE2B_VIA_PSA
#define MBEDTLS_MD_SOME_PSA
#endif
