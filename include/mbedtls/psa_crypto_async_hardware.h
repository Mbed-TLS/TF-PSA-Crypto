...
#define MBEDTLS_PSA_ASYNC_CRYPTO_CAPABILITY_RSA_CRT ((mbedtls_psa_async_crypto_capability_t)1 << 16)
...
#define MBEDTLS_PSA_ASYNC_CRYPTO_CAPABILITY_AES_CFB ((mbedtls_psa_async_crypto_capability_t)1 << 19)
#define MBEDTLS_PSA_ASYNC_CRYPTO_CAPABILITY_AES_OFB ((mbedtls_psa_async_crypto_capability_t)1 << 20)
