...
#ifndef PSA_CRYPTO_MBEDTLS_PRIVATE_CONFIG_ADJUST_PSA_SUPERSET_LEGACY_H
#define PSA_CRYPTO_MBEDTLS_PRIVATE_CONFIG_ADJUST_PSA_SUPERSET_LEGACY_H
...
#endif /* PSA_CRYPTO_MBEDTLS_PRIVATE_CONFIG_ADJUST_PSA_SUPERSET_LEGACY_H */
