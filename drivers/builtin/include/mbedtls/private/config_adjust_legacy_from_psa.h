...
#if defined(PSA_WANT_ALG_ASCON_CXOF128) && !defined(MBEDTLS_PSA_ACCEL_ALG_ASCON_CXOF128)
#define MBEDTLS_PSA_BUILTIN_ALG_ASCON_CXOF128 1
#endif
...
#if defined(PSA_WANT_ALG_ASCON_XOF128) && !defined(MBEDTLS_PSA_ACCEL_ALG_ASCON_XOF128)
#define MBEDTLS_PSA_BUILTIN_ALG_ASCON_XOF128 1
#endif
