...
#ifndef PSA_CRYPTO_MBEDTLS_CONFIG_ADJUST_LEGACY_CRYPTO_H
#define PSA_CRYPTO_MBEDTLS_CONFIG_ADJUST_LEGACY_CRYPTO_H
...
#endif /* PSA_CRYPTO_MBEDTLS_CONFIG_ADJUST_LEGACY_CRYPTO_H */
