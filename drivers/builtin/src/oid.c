...
#define OID_DESCRIPTOR(s)                     { ADD_LEN(s) }
...
static const oid_ecp_grp_t oid_ecp_grp[] =
{
    ...
    {
        OID_DESCRIPTOR(MBEDTLS_OID_EC_GRP_SECP192R1),
        MBEDTLS_ECP_DP_SECP192R1,
    },
#endif /* PSA_WANT_ECC_SECP_R1_192 */
#if defined(PSA_WANT_ECC_SECP_R1_224)
    {
        OID_DESCRIPTOR(MBEDTLS_OID_EC_GRP_SECP224R1),
        MBEDTLS_ECP_DP_SECP224R1,
    },
#endif /* PSA_WANT_ECC_SECP_R1_224 */
#if defined(PSA_WANT_ECC_SECP_R1_256)
    {
        OID_DESCRIPTOR(MBEDTLS_OID_EC_GRP_SECP256R1),
        MBEDTLS_ECP_DP_SECP256R1,
    },
#endif /* PSA_WANT_ECC_SECP_R1_256 */
#if defined(PSA_WANT_ECC_SECP_R1_384)
    {
        OID_DESCRIPTOR(MBEDTLS_OID_EC_GRP_SECP384R1),
        MBEDTLS_ECP_DP_SECP384R1,
    },
#endif /* PSA_WANT_ECC_SECP_R1_384 */
#if defined(PSA_WANT_ECC_SECP_R1_521)
    {
        OID_DESCRIPTOR(MBEDTLS_OID_EC_GRP_SECP521R1),
        MBEDTLS_ECP_DP_SECP521R1,
    },
#endif /* PSA_WANT_ECC_SECP_R1_521 */
#if defined(PSA_WANT_ECC_SECP_K1_192)
    {
        OID_DESCRIPTOR(MBEDTLS_OID_EC_GRP_SECP192K1),
        MBEDTLS_ECP_DP_SECP192K1,
    },
#endif /* PSA_WANT_ECC_SECP_K1_192 */
#if defined(PSA_WANT_ECC_SECP_K1_256)
    {
        OID_DESCRIPTOR(MBEDTLS_OID_EC_GRP_SECP256K1),
...
static const oid_ecp_grp_algid_t oid_ecp_grp_algid[] =
{
    ...
    {
        OID_DESCRIPTOR(MBEDTLS_OID_X25519),
        MBEDTLS_ECP_DP_CURVE25519,
    },
#endif /* PSA_WANT_ECC_MONTGOMERY_255 */
#if defined(PSA_WANT_ECC_MONTGOMERY_448)
    {
        OID_DESCRIPTOR(MBEDTLS_OID_X448),
...
static const oid_cipher_alg_t oid_cipher_alg[] =
{
    ...
    {
        OID_DESCRIPTOR(MBEDTLS_OID_AES_128_CBC),
    ...
    {
        OID_DESCRIPTOR(MBEDTLS_OID_AES_256_CBC),
...
static const oid_md_alg_t oid_md_alg[] =
{
    ...
    {
        OID_DESCRIPTOR(MBEDTLS_OID_DIGEST_ALG_MD5),
        MBEDTLS_MD_MD5,
    },
#endif
#if defined(PSA_WANT_ALG_SHA_1)
    {
        OID_DESCRIPTOR(MBEDTLS_OID_DIGEST_ALG_SHA1),
        MBEDTLS_MD_SHA1,
    },
#endif
    ...
    {
        OID_DESCRIPTOR(MBEDTLS_OID_DIGEST_ALG_SHA3_224),
        MBEDTLS_MD_SHA3_224,
    },
#endif
#if defined(PSA_WANT_ALG_SHA3_256)
    {
        OID_DESCRIPTOR(MBEDTLS_OID_DIGEST_ALG_SHA3_256),
        MBEDTLS_MD_SHA3_256,
    },
#endif
#if defined(PSA_WANT_ALG_SHA3_384)
    {
        OID_DESCRIPTOR(MBEDTLS_OID_DIGEST_ALG_SHA3_384),
        MBEDTLS_MD_SHA3_384,
    },
#endif
...
#if defined(PSA_WANT_ALG_SHA_1)
    {
        OID_DESCRIPTOR(MBEDTLS_OID_HMAC_SHA1),
        MBEDTLS_MD_SHA1,
    },
...
#if defined(PSA_WANT_ALG_SHA3_224)
    {
        OID_DESCRIPTOR(MBEDTLS_OID_HMAC_SHA3_224),
        MBEDTLS_MD_SHA3_224,
    },
#endif /* PSA_WANT_ALG_SHA3_224 */
#if defined(PSA_WANT_ALG_SHA3_256)
    {
        OID_DESCRIPTOR(MBEDTLS_OID_HMAC_SHA3_256),
        MBEDTLS_MD_SHA3_256,
    },
#endif /* PSA_WANT_ALG_SHA3_256 */
#if defined(PSA_WANT_ALG_SHA3_384)
    {
        OID_DESCRIPTOR(MBEDTLS_OID_HMAC_SHA3_384),
        MBEDTLS_MD_SHA3_384,
    },
#endif /* PSA_WANT_ALG_SHA3_384 */
#if defined(PSA_WANT_ALG_SHA3_512)
    {
        OID_DESCRIPTOR(MBEDTLS_OID_HMAC_SHA3_512),
        MBEDTLS_MD_SHA3_512,
    },
#endif /* PSA_WANT_ALG_SHA3_512 */
#if defined(PSA_WANT_ALG_RIPEMD160)
    {
        OID_DESCRIPTOR(MBEDTLS_OID_HMAC_RIPEMD160),
        MBEDTLS_MD_RIPEMD160,
    },
