 ...
 */
int pk_parse_rsa_key(mbedtls_pk_context *pk, const unsigned char *key, size_t key_len);

/*
 * Parse an RSA public key.
 */
int pk_parse_rsa_pubkey(mbedtls_pk_context *pk, const unsigned char *key, size_t key_len);
