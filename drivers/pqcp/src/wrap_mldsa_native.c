...
#if !defined(TF_PSA_CRYPTO_PQCP_MLDSA_OWN_SHAKE)
#  define MLD_CONFIG_FIPS202_CUSTOM_HEADER "fips202_mbedtls.h"
#  define MLD_CONFIG_SERIAL_FIPS202_ONLY
#endif /* !defined(TF_PSA_CRYPTO_PQCP_MLDSA_OWN_SHAKE) */
